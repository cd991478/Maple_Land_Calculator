...
- 프로그램 실행시 첫번째 탭인 메소 판매 화면이 띄워집니다.
- 메소 판매 탭에서는 자신이 보유한 게임 머니가 현금으로 얼마의 가치가 있는지 계산할 수 있습니다.
- 보유한 게임머니를 입력하고, 각 판매 방식별 시세를 입력한뒤 계산 버튼을 누르면 판매 방식별 순수익, 수수료가 계산됩니다.
- 어떤 방식의 판매가 얼마나 더 이득인지 하단에 표시됩니다.
...
- 아이템 판매 탭에서는 인게임 아이템 판매시 수수료를 제외한 순수익이 얼마인지 계산할 수 있으며, 수수료와 각종 비용을 계산할 수 있습니다.
- 인게임 아이템 판매 가격과 이동시 소모 비용을 입력후, 거래 방식을 선택하고 계산을 누르면 수수료와 각종 비용, 순수익이 계산됩니다.
